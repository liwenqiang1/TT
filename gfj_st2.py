...
def rjy_sql(sql_ip, predict, dt, sv_old, sv_new, sv_di):
    ...
    insert_emp_sql = "insert into pre_15min_rjy1(pre_rjy2, pre_date, old_sv, new_sv, sv_dif) values(%s, %s, %s, %s,%s)"
...
def adjust_sv(rjy):
    ...
    sql = 'select created_at, `SQ-T2-GFJ4-40026`, `SQ-T2-GFJ4-40100` from sq_gfj4_record_v2_202211 order by created_at desc limit 1'
    gfj2_sv = pd.read_sql(sql, conn_gfj1)
    time_gfj2 = gfj2_sv['SQ-T2-GFJ4-40100']
    time_gfj2_1 = int(time_gfj2)
...
def pre_do(test_new):
    ...
    :return:
    """
    #model = load_model('D:\\Users\\Administrator\\PycharmProject\\shuangqing_DO\\model_rjy2\\rjy2_wavelet_15min_step4_6.h5')
    #model = load_model('D:\\Users\\Administrator\\PycharmProject\\shuangqing_DO\\model_rjy2\\rjy2_wavelet_15min_step4_10.h5')

    #model = load_model('D:\\Users\\Administrator\\PycharmProject\\shuangqing_DO\\model_rjy2\\rjy2_wavelet_15min_step4_9.h5')
    #model = load_model('D:\\Users\\Administrator\\PycharmProject\\shuangqing_DO\\model_rjy2\\rjy2_wavelet_15min_step4_11.h5')
    #model = load_model('D:\\Users\\Administrator\\PycharmProject\\shuangqing_DO\\model_rjy2\\rjy2_wavelet_15min_step4_12.h5')
    #model = load_model('D:\\Users\\Administrator\\PycharmProject\\shuangqing_DO\\model_rjy2\\rjy2_wavelet_15min_step3_8.h5')
    #model = load_model('D:\\Users\\Administrator\\PycharmProject\\shuangqing_DO\\model_rjy2\\rjy2_wavelet_15min_step3_9.h5')
    model = load_model('D:\\Users\\Administrator\\PycharmProject\\shuangqing_DO\\model_rjy2\\rjy2_wavelet_15min_step4_13.h5')
    print('---model.summary--')
    model.summary()
...
def flow_and_sv():
    ...
    #st_model = joblib.load('D:\\Users\\Administrator\\PycharmProject\\shuangqing_DO\\model\\stand_wavelet_15min_step4_6')
    #st_model = joblib.load('D:\\Users\\Administrator\\PycharmProject\\shuangqing_DO\\model\\stand_wavelet_15min_step4_9')
    #st_model = joblib.load('D:\\Users\\Administrator\\PycharmProject\\shuangqing_DO\\model\\stand_wavelet_15min_step4_10')
    #st_model = joblib.load('D:\\Users\\Administrator\\PycharmProject\\shuangqing_DO\\model\\stand_wavelet_15min_step4_11')
    #st_model = joblib.load('D:\\Users\\Administrator\\PycharmProject\\shuangqing_DO\\model\\stand_wavelet_15min_step4_12')
    #st_model = joblib.load('D:\\Users\\Administrator\\PycharmProject\\shuangqing_DO\\model\\stand_wavelet_15min_step3_8')
    #st_model = joblib.load('D:\\Users\\Administrator\\PycharmProject\\shuangqing_DO\\model\\stand_wavelet_15min_step3_9')
    st_model = joblib.load('D:\\Users\\Administrator\\PycharmProject\\shuangqing_DO\\model\\stand_wavelet_15min_step4_13')   #11.15
    ...
    print('准备插入数据')
    rjy_sql('192.168.18.23', no_flow_rjy2, dt1, sv1, sv2, sv_dif)   #pre_15min_rjy1 #11.15
